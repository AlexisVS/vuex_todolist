<template>
  <div class="w-full flex justify-between px-4 py-2 text-white rounded-full bg-gray-800">
    <p>{{ todo.text }}</p>
    <button class="border-0" @click="deleteTodoItem(todo.id)">
      <svg
        version="1.1"
        id="Capa_1"
